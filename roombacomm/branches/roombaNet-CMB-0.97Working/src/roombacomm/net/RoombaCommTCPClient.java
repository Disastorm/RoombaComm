...
import java.io.*;
/*
 *  SVN id value is $Id: RoombaCommTCPClient.java 52 2009-08-16 06:20:26Z jpitts $
 */
public class RoombaCommTCPClient extends RoombaComm implements Runnable
{
    ...
    public boolean connect(String portid) {
        ...
        if( s.length < 2 ) {
	        ...
	        try {
	            ...
	            socket.setSoTimeout(10000);// timeout in milliseconds	
	            input = socket.getInputStream();
	            output = socket.getOutputStream();
	            //thread = new Thread(this);
	            //thread.start();
	            this.setConnected(true); // I guess we are connected now
	        } catch( Exception e ) {
    ...
    // FIXME .. copied from RoombaCommSerial
    // this is not working properly.... CMB.2009.06.16
